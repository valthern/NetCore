    ...
    public partial class DatosDePrueba : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2023, 2, 2, 0, 0, 0, 0, DateTimeKind.Local), new DateTime(2023, 1, 26, 0, 0, 0, 0, DateTimeKind.Local), 10m },
                    { 2, 4, new DateTime(2023, 1, 31, 0, 0, 0, 0, DateTimeKind.Local), new DateTime(2023, 1, 26, 0, 0, 0, 0, DateTimeKind.Local), 15m }
                });
